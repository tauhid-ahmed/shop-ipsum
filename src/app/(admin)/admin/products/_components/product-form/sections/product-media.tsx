  ...
  return (
    ...
    >
      <Card>
        ...
        <CardContent>
          <div className="size-60 rounded border-2 border-dashed border-border flex items-center justify-center">
        ...
        <CardFooter>
          <div className="w-full flex [&>*]:flex-1 gap-6 justify-between text-center border border-border p-6 border-dashed leading-tight bg-accent/50 rounded">
            <span>
              <span className="font-bold text-xl block">4</span>
              <span className="text-muted-foreground">Images</span>
            </span>
            <span>
              <span className="font-bold text-xl block">4.8MB</span>
              <span className="text-muted-foreground">Storage Used</span>
            </span>
            <span>
              <span className="font-bold text-xl block">10</span>
